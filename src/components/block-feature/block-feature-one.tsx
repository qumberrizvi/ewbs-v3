...
const BlockFeatureOne = ({style_2 = false}: { style_2?: boolean }) => {
    const service_items = service_data.filter(s => s.page === 'home-main')
    return (
        <div
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 wow fadeInUp">
                            <UpperCardItem icon={icon_1} title='Client-Centric'
                                           subtitle='Customized solutions crafted for your unique success.'/>
                        </div>
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                            <UpperCardItem icon={icon_2} title='Cross-Domain Expertise'
                                           subtitle='Experts in legal, finance, real estate, IT, and marketing solutions.'/>
                        </div>
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                            <UpperCardItem icon={icon_3} title='Strategic Location Insights'
                                           subtitle='Leverage location insights for success in Freezone or Mainland.'/>
                        </div>
                    </div>
                </div>
            </div>}
