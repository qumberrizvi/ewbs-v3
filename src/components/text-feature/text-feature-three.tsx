                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div
                                ...
                                <div className="title-one">
                                    <div className="upper-title">Unlock Your Business Potential</div>
                                    <h2>Expert Guidance for Expansion and Success</h2>
                                </div>
                                <p className="text-lg mt-35 lg-mt-10 mb-30">At EWBS Excellence Business Services, your
                                    success is our mission. As your dedicated business advisors, we offer tailored
                                    solutions to unlock your potential for growth and profitability.</p>
                                ...
                                <div className="counter-wrapper mt-50 lg-mt-40 pt-5">
                                    <div className="row">
                                        <div className="col-xl-6 col-sm-5">
                                            <div className="counter-block-one mt-20">
                                                <div className="main-count fw-bold">
                                                    <span className="counter">10</span>x
                                                </div>
                                                <p className="m0">Rapid business grow</p>
                                            </div>
                                        </div>
                                        <div className="col-xl-6 col-sm-7">
                                            <div className="counter-block-one mt-20">
                                                <div className="main-count fw-bold"><span
                                                    className="counter">95</span>%
                                                </div>
                                                <p className="m0">Client Satisfaction Rating</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-xxl-7 col-lg-6 wow fadeInLeft">
                                <div
                                    className="media-list-item me-auto pe-xxl-5 pe-4 ps-xxl-5 ps-4 pb-35 md-mt-40 d-flex align-items-end">
