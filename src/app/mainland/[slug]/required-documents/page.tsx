import {IMainland, mainlandData} from "@/data/mainland-data";
...
const MainlandRequiredDocuments = ({params}: Props) => {
    const mainland = mainlandData.find((mainland: IMainland) => mainland.slug === params.slug);
    return (
        <Wrapper>
            <div className="main-page-wrapper">
                ...
                <main>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-8 text-center">
                                    ...
                                    <h1 className="hero-heading no-bg text-white">
                                        {(mainland) ? `${mainland.zoneName} Required Documents` : 'Not Found'}
                                    </h1>
                                </div>
                                <div className="col-lg-2"></div>
                            </div>
                    ...
                    {
                        (mainland) ? (
                            <FreezoneMainlandDetailsArea data={mainland} type={'mainland'} requiredDocuments={true}/>
                        ) : (
...
export default MainlandRequiredDocuments;